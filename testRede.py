...
imagem1 = 'emboli/im0382.ppm'
print("Imagem 1 - ", classificar_imagem(imagem1))
imagem2 = 'normal/im0253.ppm'
print("Imagem 2 - ", classificar_imagem(imagem2))
imagem3 = 'normal/im0199.ppm'
print("Imagem 3 - ", classificar_imagem(imagem3))
imagem4 = 'normal/im0076.ppm'
print("Imagem 4 - ", classificar_imagem(imagem4))
imagem5 = 'outros/im0067.ppm'
print("Imagem 5 - ", classificar_imagem(imagem5))